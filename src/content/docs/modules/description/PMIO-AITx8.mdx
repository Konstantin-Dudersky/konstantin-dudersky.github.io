...
На плате есть разъём для подключения модуля светодиодов [PMLD-10](/modules/description/pmld-10). Для управления состоянием светодиодов используется GPIO-расширитель **MCP23017**. Адрес на шине I²C - `0x20`.
